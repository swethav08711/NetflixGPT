      ...
      createUserWithEmailAndPassword(
        ...
        .then((userCredential) => {
          ...
          updateProfile(user, {
            ...
            photoURL:
              "https://media.licdn.com/dms/image/D4D03AQGj3RTBsm7Vcw/profile-displayphoto-shrink_800_800/0/1686511126185?e=1723680000&v=beta&t=7KI5bxWWivLW8FCFru2tGIJfJO9ycAn025cUOh_x3Uk",
          })
            .then(() => {
